const cmsData = {
  ...
  aboutSection: {
    ...
    aboutCards: [
      `MEWA is launching a regulatory sandbox to support innovative technologies in the critical sectors of Environment, Water and Agriculture`,
      `The regulatory sandbox program will provide controlled test environments in which innovative technologies and business models can be tried out under the supervision of the regulator`,
      `By participating in MEWA’s regulatory sandbox, innovators can tackle regulatory challenges head-on and address barriers to innovation`,
    ],
  },
  objectivesSection: {
    objectivesTitle: `Objectives of the Regulatory Sandbox`,
    objectivesLeftText: `Address regulatory barriers facing innovators`,
    objectivesRightText: `Ensure regulations are adaptive to innovation trends & disruptions`,
  },
  eligibilitySection: {
  ...
  coreThemesSection: {
    ...
    coreThemesIconBullet: `mewa-bullet.png`,
    coreThemesCard: [
      {
        iconImg: `icon-8.png`,
  ...
  whyApplySection: {
    ...
    whyApplyDescription: `MEWA’s regulatory sandbox offers innovators a one-of-a-kind opportunity to accelerate the journey to scaling their innovations in KSA. Engage directly with regulators to help shape the regulatory landscape for emerging technologies, access tailored regulatory guidance and support for your innovation, and test and refine your innovation in a controlled environment with regulatory oversight`,
  },
  applyToSection: {
    ...
    applyToNote: `*Note: Applications open for MEWA Regulatory Sandbox Apply before December 31, 2024`,
  },
};
