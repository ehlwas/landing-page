const cmsData = {
  headerSection: {
    ...
    bigText: `MEWA Regulatory Sandbox test`,
  ...
  aboutSection: {
    ...
    aboutDescription: `MEWA is launching a regulatory sandbox to support innovative technologies in the critical sectors of Environment, Water and Agriculture. The regulatory sandbox program will provide controlled test environments in which innovative technologies and business models can be tried out under the supervision of the regulator. By participating in MEWA’s regulatory sandbox, innovators can tackle regulatory challenges head-on and address barriers to innovation`
  },
  objectivesSection: {
